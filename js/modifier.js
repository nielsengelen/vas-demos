function loadInfo(value) {
	switch (value) {
		...
		case 'bfsshp':
			$('#rightcolumn2').width('100%');
			$('#rightcolumn2').html('<iframe src="lab/boss_hp/tutorial.html?autofit=true" width="100%" height="100%"></iframe>');
			break;
		case 'bfssna':
			$('#rightcolumn2').width('100%');
		...
		case 'hpstoreonce':
			$('#rightcolumn2').width('100%');
			$('#rightcolumn2').html('<iframe src="lab/hpstoreonce/tutorial.html?autofit=true" width="100%" height="100%"></iframe>');
			break;
		case 'fp':
			$('#rightcolumn2').width('100%');
		...
		case 'vlbss':
			$('#rightcolumn4').width('100%');
			$('#rightcolumn4').html('<iframe src="lab/virtuallab_ss/tutorial.html?autofit=true" width="100%" height="100%"></iframe>');
			break;
		case 'appb':
			$('#rightcolumn4').width('100%');
...
function reset() {
	...
	$('#leftcolumn3').html('<img src="images/vp.png" class="menuimg" /><span class="menutitle"><br />Verified Protection</span><br /><ul class="menuitems"><li><a href="javascript:loadInfo:loadInfo(\'srb\')">SureBackup</a></li><li><a href="javascript:loadInfo:loadInfo(\'srr\')">SureReplica</a></li></ul>');
