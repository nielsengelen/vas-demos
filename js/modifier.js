function loadInfo(value) {
	switch (value) {
		...
		case 'cloud_azure':
			$('#rightcolumn1').width('100%');
			$('#rightcolumn1').html('<iframe src="lab/cloud_azure/tutorial.html?autofit=true" width="100%" height="100%"></iframe>');
			break;
		case 'vcloudss':
			$('#rightcolumn1').width('100%');
			$('#rightcolumn1').html('<iframe src="lab/vcloudss/tutorial.html?autofit=true" width="100%" height="100%"></iframe>');
			break;
		case 'vead':
			$('#rightcolumn1').width('100%');
		...
		case 'bfssnimble':
			$('#rightcolumn2').width('100%');
			$('#rightcolumn2').html('<iframe src="lab/boss_nimble/tutorial.html?autofit=true" width="100%" height="100%"></iframe>');
			break;
		case 'emcdd':
			$('#rightcolumn2').width('100%');
		...
		case 'refs':
			$('#rightcolumn2').width('100%');
			$('#rightcolumn2').html('<iframe src="lab/refs/tutorial.html?autofit=true" width="100%" height="100%"></iframe>');
			break;
...
function reset() {
	...
	$('#leftcolumn1').html('<img src="images/hsr.png" class="menuimg" /><span class="menutitle"><br />High Speed Recovery</span><br /><ul class="menuitems"><li><a href="javascript:loadInfo:loadInfo(\'ivm\')">Instant VM Recovery</a></li><li><a href="javascript:loadInfo:loadInfo(\'iflrl\')">Instant File-level Recovery<br />(Linux)</a></li><li><a href="javascript:loadInfo:loadInfo(\'iflrw\')">Instant File-level Recovery<br />(Windows)</a></li><br /><li><a href="javascript:loadInfo(\'cloud_azure\')">Direct Restore to Azure <span class="vnewfeature">(v9.5)</span></a></li><li><a href="javascript:loadInfo(\'vcloudss\')">vCloud Director Self Service <span class="vnewfeature">(v9.5)</span></a></li><br /><span class="menuheader">Veeam Explorers:</span><br /><li><a href="javascript:loadInfo:loadInfo(\'vead\')">Microsoft Active Directory</a></li><li><a href="javascript:loadInfo:loadInfo(\'vex\')">Microsoft Exchange</a></li><li><a href="javascript:loadInfo:loadInfo(\'vesp\')">Microsoft SharePoint</a></li><li><a href="javascript:loadInfo:loadInfo(\'vesql\')">Microsoft SQL Server</a></li><br /><li><a href="javascript:loadInfo(\'veora\')">Oracle <span class="vnewfeature">(v9)</span></a></li></ul>');
	$('#rightcolumn2').width('85%');
	$('#leftcolumn2').html('<img src="images/dla.png" class="menuimg" /><span class="menutitle"><br />Data Loss Avoidance</span><br /><ul class="menuitems"><li><a href="javascript:loadInfo(\'bj\')">Backup Job</a></li><li><a href="javascript:loadInfo(\'bcj\')">Backup Copy Job</a></li><li><a href="javascript:loadInfo(\'rj\')">Replication Job</a></li><br /><li><a href="javascript:loadInfo(\'bioc\')">Backup I/O Control</li><li><a href="javascript:loadInfo(\'fp\')">Failover Plan</li><li><a href="javascript:loadInfo(\'vcc\')">Veeam Cloud Connect <span class="vnewfeature">(v9)</span></a></li><br /><li><a href="javascript:loadInfo(\'refs\')">Advanced ReFS integration <span class="vnewfeature">(v9.5)</a></span></li><li><a href="javascript:loadInfo(\'pvmbc\')">Per-VM Backup Chain <span class="vnewfeature">(v9)</a></span></li><li><a href="javascript:loadInfo(\'sobr\')">Scale-Out Backup Repository <span class="vnewfeature">(v9)</a></span></li><br /><span class="menuheader">Backup from Storage Snapshots:</span><br /><li><a href="javascript:loadInfo(\'bfssemc\')">EMC VNX(e)</a> <span class="vnewfeature">(v9)</span></li><li><a href="javascript:loadInfo(\'bfsshpe\')">HPE StoreVirtual/StoreServ</a></li><li><a href="javascript:loadInfo(\'bfssna\')">NetApp FAS</a></li><li><a href="javascript:loadInfo(\'bfssnimble\')">Nimble</a> <span class="vnewfeature">(v9.5)</span></li><br /><span class="menuheader">Deduplicating Storage:</span><br /><li><a href="javascript:loadInfo(\'emcdd\')">EMC Data Domain Boost</a></li><li><a href="javascript:loadInfo(\'exagrid\')">Exagrid</a></li><li><a href="javascript:loadInfo(\'storeonce\')">HPE StoreOnce Catalyst <span class="vnewfeature">(v9)</span></a></li><br /><span class="menuheader">Native Tape Support:</span><br /><li><a href="javascript:loadInfo(\'ntt\')">Backup to Tape</a></li><li><a href="javascript:loadInfo(\'tapegfs\')">GFS media pool <span class="vnewfeature">(v9)</span></a></li><li><a href="javascript:loadInfo(\'tapeglobal\')">Global media pool <span class="vnewfeature">(v9)</span></a></li></ul>');
	...
	$('#leftcolumn4').html('<img src="images/ld.png" class="menuimg" /><span class="menutitle"><br />Leveraged Data</span><br /><ul class="menuitems"><li><a href="javascript:loadInfo(\'vlb\')">Virtual Lab</a></li><br /><span class="menuheader">On-Demand Sandbox:</span><br /><li><a href="javascript:loadInfo(\'appb\')">Application Groups (Backups)</a></li><li><a href="javascript:loadInfo(\'appr\')">Application Groups (Replicas)</a></li><li><a href="javascript:loadInfo(\'appss\')">Application Groups (Storage Snapshot) <span class="vnewfeature">(v9)</span></a></a></li></ul>');
...
function resetMain() {
	...
	$('#leftcolumn2', window.parent.document).html('<img src="images/dla.png" class="menuimg" /><span class="menutitle"><br />Data Loss Avoidance</span><br /><ul class="menuitems"><li><a href="javascript:loadInfo(\'bj\')">Backup Job</a></li><li><a href="javascript:loadInfo(\'bcj\')">Backup Copy Job</a></li><li><a href="javascript:loadInfo(\'rj\')">Replication Job</a></li><br /><li><a href="javascript:loadInfo(\'bioc\')">Backup I/O Control</li><li><a href="javascript:loadInfo(\'fp\')">Failover Plan</li><li><a href="javascript:loadInfo(\'vcc\')">Veeam Cloud Connect</a></li><br /><li><a href="javascript:loadInfo(\'refs\')">Advanced ReFS integration <span class="vnewfeature">(v9.5)</a></span></li><li><a href="javascript:loadInfo(\'pvmbc\')">Per-VM Backup Chain <span class="vnewfeature">(v9)</a></span></li><li><a href="javascript:loadInfo(\'sobr\')">Scale-Out Backup Repository <span class="vnewfeature">(v9)</a></span><br /><br /><span class="menuheader">Backup from Storage Snapshots:</span><br /><li><a href="javascript:loadInfo(\'bfssemc\')">EMC VNX(e)</a> <span class="vnewfeature">(v9)</span></li><li><a href="javascript:loadInfo(\'bfsshp\')">HP StoreVirtual/StoreServ</a></li><li><a href="javascript:loadInfo(\'bfssna\')">NetApp FAS</a></li><li><a href="javascript:loadInfo(\'bfssnimble\')">Nimble</a> <span class="vnewfeature">(v9.5)</span></li><br /><span class="menuheader">Deduplicating Storage:</span><br /><li><a href="javascript:loadInfo(\'emcdd\')">EMC Data Domain Boost</a></li><li><a href="javascript:loadInfo(\'exagrid\')">Exagrid</a></li><li><a href="javascript:loadInfo(\'hpstoreonce\')">HP StoreOnce Catalyst <span class="vnewfeature">(v9)</span></a></li><br /><span class="menuheader">Native Tape Support:</span><br /><li><a href="javascript:loadInfo(\'ntt\')">Backup to Tape</a></li><li><a href="javascript:loadInfo(\'tapegfs\')">GFS media pool <span class="vnewfeature">(v9)</span></a></li><li><a href="javascript:loadInfo(\'tapeglobal\')">Global media pool <span class="vnewfeature">(v9)</span></a></li></ul>');
